...
describe('Запросы пользователей', () => {
    ...
    test('администратор за администратора…', async () => {
        ...
        expect(
            await closure.handleCommandThenTts(
                'администратор за администратора администратора администратора'
            )
    ...
    test('между нами тает лед…', async () => {
        ...
        await closure.handleCommand('');
        expect(await closure.handleCommandThenTts('между нами тает лед позвал бабку')).toMatch(
            'бабка за дедку'
        );
    });
    ...
    test('снегурочку и деда мороза…', async () => {
        ...
        await closure.handleCommand('');
        expect(
            await closure.handleCommandThenTts('снегурочку и деда мороза после нирваны')
        ).toMatch('дед мороз за дедку');
    });
    ...
    test('уже вытащили давно…', async () => {
        ...
        await closure.handleCommand('');
        expect(
            await closure.handleCommandThenTts('я уже вытащили давно что вы тут лечите')
        ).toMatch('Это не похоже на персонажа');
    });
    ...
    test('как тебя зовут…', async () => {
        ...
        await closure.handleCommand('');
        expect(await closure.handleCommandThenTts('да только как тебя зовут алиса что ли')).toMatch(
            'алиса за дедку'
        );
    });
    ...
    test('золотую внучку…', async () => {
        ...
        await closure.handleCommand('');
        expect(await closure.handleCommandThenTts('золотую внучку которая н не золотая')).toMatch(
    ...
    test('сестру русалку…', async () => {
        ...
        await closure.handleCommand('');
        expect(
            await closure.handleCommandThenTts('русалка позвала свою еще 1 сестру русалку')
        ).toMatch('сестра русалка за дедку');
    });
    ...
    test('черную причерную тучу…', async () => {
        ...
        await closure.handleCommand('');
        expect(
            await closure.handleCommandThenTts('черную причерную тучу при тучу тучу тучу')
        ).toMatch('звал дедка тучу');
    });
    ...
    test('ну и что то мы сдаемся…', async () => {
        ...
        await closure.handleCommand('');
        expect(await closure.handleCommandThenTts('ну и что то мы сдаемся уже хватит уже')).toMatch(
    ...
    test('александра валерьевича…', async () => {
        ...
        await closure.handleCommand('');
        expect(await closure.handleCommandThenTts('он позвал александра валерьевича')).toMatch(
    ...
    test('маньяк загадку гальки…', async () => {
        ...
        await closure.handleCommand('');
        expect(await closure.handleCommandThenTts('маньяк загадку гальки за 300 за соплю')).toMatch(
            /сопля за дедку/
        );
    });
    ...
    test('жучка не умеет говорить…', async () => {
        ...
        expect(
            await closure.handleCommandThenTts(
                'жучка не умеет говорить она не может никого позвать'
            )
        ).toMatch(/ж\+учка за дедку/);
    });
});
